...
<div class="playlist_box" oncontextmenu="event.preventDefault()">
	<div style=";margin-bottom:8px;position:relative">
		<div style="font-weight:bold;font-size:15px;"><a href="/playlist?p=<?php echo $Playlist_Videos[0]["purl"]; ?>"><?= $Playlist_Videos[0]["ptitle"] ?></a></div>
	...
	<div id="plcontainer">
		...
		<a href="/watch?v=<?= $PVideo["url"] ?>&pl=<?= $_GET["pl"] ?>"<? if ($PVideo["url"] == $URL) : ?> style="background:#dddddd" id="plwatching"<? endif ?>>
			<img src="/vi/<?= $PVideo["url"] ?>/sqresdefault.jpg">
			<div>
